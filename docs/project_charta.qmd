...
gantt
    ...
    data collection (version one) finished :milestone, 2025-07-09
    data collection (version two) started :a7, 2025-07-09
    data collection (version two) finished :milestone, 2025-07-10
    data collection (version three) created :a8, 2025-07-16
    data collection (version three) finished :milestone, 2025-07-19

    section Data cleaning
    cleaning pokemon images :a5, 2025-07-07, 3d

    section Model Training
    logistic regression model created :a9, 2025-07-10
    random forest model created :a10, 2025-07-09
    gradient bosting model created :a11, 2025-07-????
...
- Battle Simulation and data collection
